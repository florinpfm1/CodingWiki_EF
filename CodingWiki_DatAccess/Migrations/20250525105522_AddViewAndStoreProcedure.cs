...
{
    /// <inheritdoc />
    public partial class AddViewAndStoreProcedure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                CREATE OR ALTER VIEW dbo.GetMainBookDetails 
                AS
                SELECT m.ISBN, m.Title, m.Price FROM dbo.Books m
            ");
            migrationBuilder.Sql(@"
                CREATE OR ALTER VIEW dbo.GetAllBookDetails
                AS
                SELECT * FROM dbo.Books m
            ");
            migrationBuilder.Sql(@"
                CREATE PROCEDURE dbo.getBookDetailById
                    @bookId int
                AS
                    SET NOCOUNT ON;
